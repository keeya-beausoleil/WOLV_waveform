...
station_rem_cut1.trim(starttime=start+(20*60*60)+700, endtime = start+(20*60*60)+770) # 20 = 12 noon Alaska
...
plt.xlabel("Time(s)")
plt.title("Earthquake Event on May 1st - HHZ")
plt.plot(t, station_rem_filt1[0].data,"k")
fig.savefig("temp_quakeWOLN.png")
